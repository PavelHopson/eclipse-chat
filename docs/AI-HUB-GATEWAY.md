...
Rollback is immediate: remove `ECLIPSE_AI_HUB_*` from the Chat server environment and restart it. The existing provider chain remains available throughout the canary.
