...
**Текущая версия в проде:** **v1.1.77** (Galaxy/Clock/Theme/Deadline effects +
UX-copy + дизайн-полиш + редизайн WS-1 + системный редизайн ЗАКРЫТ 8/8 +
светлая тема SOLAR + фикс AuthScreen + смена пароля + визуальный
передел AppShell слайсы 1–2/4).
