...
**Актуальная версия (короткий индекс):** **v1.7.18** — exclusive platform ownership for `garaa11@mail.ru` plus backup-gated removal of every other account's servers and scoped uploads.
