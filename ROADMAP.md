...
**Текущая версия в проде:** **v0.68.0** (Scroll containment hotfix —
ChannelList / rail / members больше не overflow за viewport на коротких
экранах. До этого v0.67.0 Link embeds, v0.66.0 Audio waveform, 17.05.2026)
— https://app.star-crm.ru/eclipse-chat/

**Предыдущие версии:** v0.67.0 (Link embeds — OG preview
...
| **#1 next** | **#28 Home expansion** | S-M | M | визуальный win, нет инфры |
