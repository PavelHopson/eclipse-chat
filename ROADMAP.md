...
**Текущая версия в проде:** **v0.59.0** (Operational Tables phase 1 —
HUGE feature §4 NEXT-GEN spike: Table/TableField/TableRow/TableCell
schema, CRUD routes, inline editable grid с 4 типами полей
(TEXT/NUMBER/STATUS/DATE), entry в ChannelList Context Tree;
realtime / relations / AI-fill — phase 2+, 17.05.2026)
...
10. 🟡 **Operational tables** — phase 1 закрыта в v0.59.0 (schema +
    CRUD + inline editable grid). Phase 2 — realtime collab, RBAC,
    advanced field types (USER/RELATION/FILE), drag-reorder, table
    templates. Phase 3 — AI-fill rows, formulas, link к ActionItem.
