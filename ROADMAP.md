...
**Актуальная версия (короткий индекс):** **v1.7.57** — безопасный Creative Studio: стоимость и human approval до выполнения, нулевая preview-цепочка, квитанция, Office Event Bus и ручная передача через LocalSend.
