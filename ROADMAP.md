...
**Актуальная версия (короткий индекс):** **v1.7.17** — platform-owner-only workspace creation with a backup-gated production cleanup path for non-owner servers and their scoped uploads.
