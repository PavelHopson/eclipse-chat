...
**Текущая версия в проде:** **v0.65.0** (Mobile hardening v2 — 14
конкретных fixes из аудита 17.05: DM-button + channel actions visible
on touch, Modal + Drawer body scroll-lock + 100dvh + safe-area, close
buttons 44×44, IntelligencePanel labels visible on mobile drawer,
StatusBoard/TeamHealth/MusicMiniPlayer/SearchOverlay/OperationalTable
explicit mobile layouts, VoiceRoom controls nowrap-scroll. До этого
v0.64.0 Account limit, v0.63.0 Security & integrity pass, 17.05.2026)
