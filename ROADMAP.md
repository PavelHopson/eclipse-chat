...
**Текущая версия в проде:** **v0.58.0** (Voice transcription prototype —
audio-attachments транскрибируются через OpenAI Whisper API
fire-and-forget после upload; status NONE/PENDING/READY/FAILED + UI
блок под audio player с live-sync через socket, 17.05.2026)
