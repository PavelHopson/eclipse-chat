...
- [ ] **Next P0: AI provider diagnostics** — admin/debug view: какие провайдеры активны, какой ответил последним, latency, model, status, без логирования PII.
- [ ] **Next P0: OpenHuman-inspired memory controls** — visible room/project memory, delete/audit controls, "since you were away" quality pass.
