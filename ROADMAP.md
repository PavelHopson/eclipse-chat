...
**Текущая версия в проде:** **v0.57.0** (Operational search v1 —
unified поиск по сообщениям, action items и файлам пространства в
одном overlay с tabs; ILIKE-based, FTS upgrade — future,
