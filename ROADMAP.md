...
| **#1 next** | **#26 phase 2** Telegram/GitHub/Notion integrations | XL | H | external workflow bridges |
| После | **#23 phase 1b Yjs CRDT upgrade** | S-M | M | true concurrent editing (когда npm registry даст yjs) |
