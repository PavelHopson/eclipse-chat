...
**Текущая версия в проде:** **v0.54.0** (Execution entity detail drawer —
ActionItem становится first-class объектом: priority + description +
comments thread + activity log; драwer с inline-editors открывается из
StatusBoard и Intelligence Execution view, 17.05.2026)
