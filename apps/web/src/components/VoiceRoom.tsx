...
const wrap: CSSProperties = {
  ...
  minHeight: 0,
  background:
    "radial-gradient(ellipse 68% 50% at 20% -10%, hsl(195 48% 17% / 0.34) 0%, transparent 55%), radial-gradient(ellipse 52% 40% at 100% 100%, hsl(220 30% 18% / 0.26) 0%, transparent 62%), var(--ec-bg)",
};
...
const boardGlow: CSSProperties = {
  ...
  height: 240,
  borderRadius: "50%",
  background: "radial-gradient(circle, hsl(195 60% 55% / 0.18) 0%, transparent 72%)",
  pointerEvents: "none",
};
...
const boardRing: CSSProperties = {
  ...
  height: 240,
  borderRadius: "50%",
  border: "1px solid hsl(195 60% 55% / 0.16)",
  boxShadow: "0 0 0 28px hsl(195 60% 55% / 0.04), inset 0 0 40px hsl(195 60% 55% / 0.08)",
  pointerEvents: "none",
};
...
const videoTileWrap: CSSProperties = {
  ...
  border: "1px solid var(--ec-border-default)",
  background:
    "radial-gradient(circle at 50% 20%, hsl(195 60% 55% / 0.18), transparent 48%), linear-gradient(180deg, hsl(208 14% 13%), hsl(210 12% 8%))",
};
...
const audioTileSpeaking: CSSProperties = {
  ...
  boxShadow: "0 0 0 1px var(--ec-accent), 0 0 24px -3px hsl(195 60% 55% / 0.45)",
...
const controlBtnAccent: CSSProperties = {
  ...
  color: "var(--ec-accent)",
  borderColor: "var(--ec-accent)",
  boxShadow: "0 0 0 1px var(--ec-border-accent), 0 0 18px -2px hsl(195 60% 55% / 0.42)",
};
...
const emptyHero: CSSProperties = {
  ...
  border: "1px solid hsl(195 60% 55% / 0.16)",
  background:
    "radial-gradient(circle at 50% 30%, hsl(195 60% 55% / 0.16) 0%, transparent 54%), linear-gradient(180deg, hsl(210 12% 10% / 0.92), hsl(210 12% 8% / 0.98))",
};
        ...
        style={{
          ...
          background:
            visual.source === "screen"
              ? "radial-gradient(circle at 50% 0%, hsl(195 60% 55% / 0.18), transparent 48%)"
                      ...
                      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "var(--ec-space-3)", textAlign: "center", maxWidth: 420 }}>
                        <span
                          style={{
                            ...
                            placeItems: "center",
                            background: "hsl(195 60% 55% / 0.12)",
                            border: "1px solid hsl(195 60% 55% / 0.22)",
                            color: "var(--ec-accent)",
                            boxShadow: "0 0 0 1px hsl(195 60% 55% / 0.18), 0 0 28px hsl(195 60% 55% / 0.2)",
                          }}
                          aria-hidden
                        >
