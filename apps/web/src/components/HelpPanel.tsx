...
const tourCards: Array<{ title: string; body: string; hint?: string }> = [
  ...
  },
  {
    ...
    body: "Правый rail, 5 табов: Сводка / Память / Дела / Файлы / Люди. Сводка = AI-prose дайджест канала. Память = «Пока тебя не было» при возврате. Дела/Файлы = scope канала. Люди = members + presence + voice state.",
