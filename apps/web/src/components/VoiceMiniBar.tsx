...
const wrap: CSSProperties = {
  ...
  background:
    "linear-gradient(180deg, hsl(258 40% 14% / 0.42), hsl(210 18% 7% / 0.96))",
    ...
    <div style={wrap} role="region" aria-label="Голосовое подключение">
      <div
        ...
        style={{
          ...
          height: 140,
          borderRadius: "50%",
          background: "radial-gradient(circle, hsl(258 90% 66% / 0.14) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
        ...
        <span
          style={{
            ...
            boxShadow: voice.pttActive
              ? "0 0 0 1.5px var(--ec-accent), 0 0 12px hsl(258 90% 66% / 0.48)"
              : "none",
